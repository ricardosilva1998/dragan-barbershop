  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-4xl font-bold mb-12 text-center">
        {t("contact.title")} <span className="text-amber-500">{t("contact.titleHighlight")}</span>
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div>
            <h2 className="text-xl font-semibold text-white mb-4">{t("contact.contactInfo")}</h2>
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-zinc-400 text-sm">{t("contact.phone")}</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-zinc-400 text-sm">{t("contact.email")}</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-zinc-400 text-sm">{t("contact.instagram")}</p>
                  <a
          ...
          {/* Map Links */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">{t("contact.getDirections")}</h3>
        ...
        <div className="bg-zinc-900 rounded-xl border border-zinc-800 p-8">
          <h2 className="text-xl font-semibold text-white mb-6">{t("contact.openingHours")}</h2>
          <div className="space-y-4">
            {[
              { day: t("hours.monday"), hours: "10:00 - 20:00" },
              { day: t("hours.tuesday"), hours: "10:00 - 20:00" },
              { day: t("hours.wednesday"), hours: "10:00 - 20:00" },
              { day: t("hours.thursday"), hours: "10:00 - 20:00" },
              { day: t("hours.friday"), hours: "10:00 - 20:00" },
              ...
              <div key={item.day} className="flex justify-between py-2 border-b border-zinc-800 last:border-0">
                ...
                <span className={`font-medium ${item.hours === t("hours.closed") ? "text-red-400" : "text-amber-500"}`}>
                  {item.hours}
                </span>
              </div>
            ))}
